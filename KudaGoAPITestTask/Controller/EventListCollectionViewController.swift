...
class EventListCollectionViewController: UICollectionViewController {
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: id, for: indexPath) as! EventCollectionViewCell
    ...
    private func getPageOfEvents() {
        NetworkService.shared.fetchEvents(for: currentPage) { result in
            switch result {
...
extension EventListCollectionViewController: UICollectionViewDelegateFlowLayout {
